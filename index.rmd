---
title: "Things we (mostly) already know about stocks"
...
eigenvalues and matrix inversion will effectively divide the noise by those
tiny values.  Simply stated, dividing by a tiny number returns a big
number--that is, matrix inversion tends to blow the noise up.
