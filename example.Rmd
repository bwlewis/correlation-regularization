...
This document presents a fun example of graph-based time series graph clustering
using stock market data. The example consists of three steps:
...
$S$ is a symmetric matrix. We also can deduce that $S$ has no negative
eigenvalues (it's positive semi-definite at least). That means that simply
...
finesse to shrink covariance matrices.
